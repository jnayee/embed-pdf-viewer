...
export const traditionalChineseTranslations: Locale = {
  ...
  translations: {
    ...
    passwordPrompt: {
      title: '請輸入密碼',
      required: '該檔案設有密碼保護，要開啟檔案請輸入密碼。',
      incorrect: '密碼不正確，請再試一次。',
      incorrectWarning: '密碼錯誤，請檢查後重新輸入。',
      label: '密碼',
      placeholder: '請輸入檔案密碼',
      open: '開啟',
      opening: '開啟中...',
    ...
    protect: {
      ...
      apply: '套用保護',
      applying: '正在套用...',
      applyFailed: '無法套用保護。請重試。',
      removeFailed: '無法移除保護。請重試。',
      passwordMismatch: '密碼不符',
      noProtectionSelected: '請至少選擇一種保護方式。',
      bothPasswordsNote:
    ...
    security: {
      protected: {
        title: '此文件受保護',
        description:
          '此文件受保護，某些功能可能被停用。請在文件選單中點擊「保護」以查看或解除權限鎖定。',
